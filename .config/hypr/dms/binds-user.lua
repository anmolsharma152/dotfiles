...
local function active_window_is_terminal()
	...
	if
		class:find("alacritty")
		or class:find("kitty")
		or class:find("ghostty")
		or class:find("wezterm")
		or class:find("terminal")
...
hl.bind(
	...
	{ description = "Clipboard Manager: Toggle" }
)
...
hl.bind(
	"SUPER + SHIFT + space",
	hl.dsp.exec_cmd("dms ipc call bar toggle index 0"),
	{ description = "Top Bar: Toggle" }
)
hl.unbind("SUPER + S")
...
hl.bind(
	...
	{ description = "Spotlight Bar: Toggle" }
)
...
hl.bind(
	...
	{ description = "Window Rules: Toggle" }
)
...
hl.bind(
	"SUPER + M",
	hl.dsp.exec_cmd("launch-or-focus spotify spotify"),
	{ description = "Music GUI: Spotify Open or Focus" }
)

hl.unbind("SUPER + SHIFT + M")
hl.bind(
	"SUPER + SHIFT + M",
	hl.dsp.exec_cmd("launch-or-focus cliamp 'alacritty --title cliamp -e cliamp'"),
	{ description = "Music TUI: cliamp Open or Focus" }
)
...
-- === GUI AI Apps (Super + A / Super + Shift + A / Super + Alt + A / Super + Ctrl + A) ===
hl.unbind("SUPER + A")
hl.bind(
	"SUPER + A",
	hl.dsp.exec_cmd("launch-or-focus antigravity antigravity"),
	{ description = "Antigravity: Open or Focus" }
)

hl.unbind("SUPER + SHIFT + A")
hl.bind(
	"SUPER + SHIFT + A",
	hl.dsp.exec_cmd("launch-or-focus chatgpt chatgpt"),
	{ description = "ChatGPT: Open or Focus" }
)

hl.unbind("SUPER + ALT + A")
hl.bind(
	"SUPER + ALT + A",
	hl.dsp.exec_cmd("launch-or-focus '(opencode-desktop|ai.opencode.desktop)' opencode-desktop"),
	{ description = "OpenCode GUI: Open or Focus" }
)

hl.unbind("SUPER + CTRL + A")
hl.bind(
	"SUPER + CTRL + A",
	hl.dsp.exec_cmd("launch-or-focus '(claude-desktop|claude|Claude)' claude-desktop"),
	{ description = "Claude Desktop: Open or Focus" }
)

-- === TUI AI Agents (Super + T / Super + Shift + T / Super + Alt + T / Super + Ctrl + T) ===
hl.unbind("SUPER + T")
...
hl.bind("SUPER + ALT + T", hl.dsp.exec_cmd("launch-agent opencode"), { description = "Launch OpenCode TUI" })

hl.unbind("SUPER + CTRL + T")
hl.bind("SUPER + CTRL + T", hl.dsp.exec_cmd("launch-agent claude"), { description = "Launch Claude Code CLI" })
...
hl.bind(
	...
	{ description = "Keybindings: Toggle" }
)
...
hl.bind(
	...
	hl.dsp.exec_cmd("workspace-cycle next --move-window"),
...
hl.bind(
	"SUPER + SHIFT + Page_Up",
	hl.dsp.exec_cmd("workspace-cycle prev --move-window"),
...
hl.bind(
	"SUPER + SHIFT + Home",
	hl.dsp.exec_cmd("workspace-cycle first --move-window"),
	{ description = "Move window to first workspace" }
)
hl.unbind("SUPER + SHIFT + End")
hl.bind(
	"SUPER + SHIFT + End",
	hl.dsp.exec_cmd("workspace-cycle last --move-window"),
...
hl.bind(
	"SUPER + SHIFT + U",
	hl.dsp.exec_cmd("wayvibes-ctl toggle"),
	{ description = "Toggle keyboard sounds (mute/unmute)" }
)
